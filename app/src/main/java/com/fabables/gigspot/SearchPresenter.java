...
public class SearchPresenter implements TrackManager.ActionListener {

    private static final String TAG = SearchPresenter.class.getSimpleName();
    public static final int PAGE_SIZE = 20;

    private final Context mContext;
    private final TrackManager.View mView;

    private TopTracksPager mSearchPager;
    private TopTracksPager.CompleteListener mSearchListener;
    ...
    public SearchPresenter(Context context, TrackManager.View view) {
        mContext = context;
        mView = view;
    }
    ...
    public void init(String accessToken) {
        ...
        mSearchPager = new TopTracksPager(spotifyApi.getService());

        mContext.bindService(PlayerService.getIntent(mContext), mServiceConnection, Activity.BIND_AUTO_CREATE);
    }

    @Override
    public void update(String timeRange) {
        mView.reset();
        mSearchListener = new TopTracksPager.CompleteListener() {
            @Override
        ...
        mSearchPager.getFirstPage(timeRange, PAGE_SIZE, mSearchListener);
    }
